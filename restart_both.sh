#!/bin/bash
# Restart both Web Dashboard and RL Bot
...
chmod +x start_web_dashboard.sh start_rl_bot.sh
...
if [ $? -eq 0 ]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        echo ""
        print_status "🎉 Both services restarted successfully!"
        echo ""
